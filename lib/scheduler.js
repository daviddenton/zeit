...
exports.PromiseScheduler = function (clock) {
    ...
    events.schedule = function (promiseFn, duration, name) {
        ...
        activeSchedules[scheduleId] = {
            ...
            clockId: clock.setTimeout(createPromiseCallbackFn(scheduleId, promiseFn, _.noop), clock.durationAsNumberOfMilliseconds(duration))
        };
        return scheduleId;
    };
    ...
    events.scheduleEvery = function (promiseFn, duration, name) {
        ...
        var callback = createPromiseCallbackFn(scheduleId, promiseFn, function () {
            activeSchedules[scheduleId].clockId = clock.setTimeout(callback, clock.durationAsNumberOfMilliseconds(duration));
        });
