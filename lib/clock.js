...
function StubTimeoutsAndIntervals() {
    ...
    return {
        ...
        timeouts: function () {
            return _.chain(timeouts).map(function (timeout, id) {
...
var StubClockwork = function (fns, current, tickSize, implicitTickFlag) {
    var current = current ? fns.ensureDate(current) : fns.dateFn(0);
    var tickSize = tickSize ? fns.ensureDuration(tickSize) : fns.durationFn(1000);
...
exports.DateClock = function () {
    return _.extend(new TimeoutsAndIntervals(numberOfMillisOrThrow), dateClockwork, dateConversions);
};
...
var momentClockwork = {
    ...
    durationUntil: function (time) {
        return this.numberOfMillisecondsAsDuration(this.now().diff(time));
    }
};
...
exports.StubMomentClock = function (current, tickSize, implicitTickFlag) {
    var fns = {
        ...
        durationDiff: function(current, other) {
            return moment.duration(current.diff(other), 'milliseconds');
        },
