...
function NativeTimeoutsAndIntervals(nowFn) {
    return {
        now: nowFn,
...
exports.DateClock = function () {
    return _.extend(new NativeTimeoutsAndIntervals(function() {
        return new Date();
    }), DateConversions);
};
...
var StubClockBase = function (fns, current, tickSize, implicitTickFlag) {
...
exports.StubMomentClock = function (current, tickSize, implicitTickFlag) {
    ...
    return _.extend(new StubClockBase(fns, current, tickSize, implicitTickFlag), MomentConversions);
};
...
exports.StubDateClock = function (current, tickSize, implicitTickFlag) {
    ...
    return _.extend(new StubClockBase(fns, current, tickSize, implicitTickFlag), DateConversions);
};
