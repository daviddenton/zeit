...
function TimeoutsAndIntervals() {
    return {
        setTimeout: function (callback, timeout) {
            return setTimeout(callback, this.durationAsNumberOfMilliseconds(timeout));
        },
        clearTimeout: function (id) {
            return clearTimeout(id);
        },
        setInterval: function (callback, interval) {
            return setInterval(callback, this.durationAsNumberOfMilliseconds(interval));
        },
...
exports.DateClock = function () {
    return _.extend(new TimeoutsAndIntervals(), dateConversions, dateClockwork);
};

exports.MomentClock = function () {
    return _.extend(new TimeoutsAndIntervals(), momentConversions, momentClockwork);
};
...
var StubClockwork = function (fns, current, tickSize, implicitTickFlag) {
    ...
    return _.extend(target, new StubTimeoutsAndIntervals());
};
...
exports.StubMomentClock = function (current, tickSize, implicitTickFlag) {
    ...
    return _.extend(new StubClockwork(fns, current, tickSize, implicitTickFlag), momentConversions);
};
...
exports.StubDateClock = function (current, tickSize, implicitTickFlag) {
    ...
    return _.extend(new StubClockwork(fns, current, tickSize, implicitTickFlag), dateConversions);
};
